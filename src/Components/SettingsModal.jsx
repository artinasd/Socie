...
function SettingsModal({ isOpen, onClose }) {
    ...
    useEffect(() => {
        if (isOpen && loggedUser) {
            ...
            try {
                const favs = typeof loggedUser.favorites === 'string' ? JSON.parse(loggedUser.favorites) : loggedUser.favorites;
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            const { error } = await api.put(`/users/${loggedUser.id}`, updateData);
            ...
            dispatch(loggedUserDataSliceActions.updateProfile({...updateData, favorites: favorites}));
